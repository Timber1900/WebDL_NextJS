...
/* harmony export */   "default": function() { return /* binding */ audioHandler; }
/* harmony export */ });
...
async function audioHandler(req, res) {
  ...
  const format = await ytdl_core__WEBPACK_IMPORTED_MODULE_0___default().chooseFormat(formats, {
    ...
    filter: vid => !vid.hasVideo
  });
  const audio = await ytdl_core__WEBPACK_IMPORTED_MODULE_0___default()(url, {
    format
  });
